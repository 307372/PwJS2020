...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.zakladki.setFocusPolicy(Qt.ClickFocus)
        self.aktywne = QWidget()
        self.aktywne.setObjectName(u"aktywne")
        self.listWidget = QListWidget(self.aktywne)
        self.listWidget.setObjectName(u"listWidget")
        self.listWidget.setGeometry(QRect(240, 160, 256, 192))
        self.zakladki.addTab(self.aktywne, "")
        self.wszystkie = QWidget()
        self.wszystkie.setObjectName(u"wszystkie")
        self.wszystkieTablica = QTableWidget(self.wszystkie)
        if (self.wszystkieTablica.columnCount() < 3):
            self.wszystkieTablica.setColumnCount(3)
        __qtablewidgetitem = QTableWidgetItem()
        self.wszystkieTablica.setHorizontalHeaderItem(0, __qtablewidgetitem)
        __qtablewidgetitem1 = QTableWidgetItem()
        self.wszystkieTablica.setHorizontalHeaderItem(1, __qtablewidgetitem1)
        __qtablewidgetitem2 = QTableWidgetItem()
        self.wszystkieTablica.setHorizontalHeaderItem(2, __qtablewidgetitem2)
        if (self.wszystkieTablica.rowCount() < 3):
            self.wszystkieTablica.setRowCount(3)
        __qtablewidgetitem3 = QTableWidgetItem()
        self.wszystkieTablica.setVerticalHeaderItem(0, __qtablewidgetitem3)
        __qtablewidgetitem4 = QTableWidgetItem()
        self.wszystkieTablica.setVerticalHeaderItem(1, __qtablewidgetitem4)
        __qtablewidgetitem5 = QTableWidgetItem()
        self.wszystkieTablica.setVerticalHeaderItem(2, __qtablewidgetitem5)
        __qtablewidgetitem6 = QTableWidgetItem()
        self.wszystkieTablica.setItem(1, 0, __qtablewidgetitem6)
        __qtablewidgetitem7 = QTableWidgetItem()
        self.wszystkieTablica.setItem(1, 1, __qtablewidgetitem7)
        ...
        self.wszystkieTablica.setItem(1, 2, __qtablewidgetitem8)
        __qtablewidgetitem9 = QTableWidgetItem()
        self.wszystkieTablica.setItem(2, 0, __qtablewidgetitem9)
        __qtablewidgetitem10 = QTableWidgetItem()
        self.wszystkieTablica.setItem(2, 1, __qtablewidgetitem10)
        ...
        self.wszystkieTablica.setItem(2, 2, __qtablewidgetitem11)
        self.wszystkieTablica.setObjectName(u"wszystkieTablica")
        self.wszystkieTablica.setGeometry(QRect(20, 10, 741, 481))
        self.wszystkieUsun = QPushButton(self.wszystkie)
        self.wszystkieUsun.setObjectName(u"wszystkieUsun")
        self.wszystkieUsun.setGeometry(QRect(690, 500, 75, 23))
        self.wszystkieEdytuj = QPushButton(self.wszystkie)
        self.wszystkieEdytuj.setObjectName(u"wszystkieEdytuj")
        self.wszystkieEdytuj.setGeometry(QRect(110, 500, 75, 23))
        self.wszystkieDodaj = QPushButton(self.wszystkie)
        self.wszystkieDodaj.setObjectName(u"wszystkieDodaj")
        self.wszystkieDodaj.setGeometry(QRect(200, 500, 75, 23))
        self.wszystkieAktywuj = QPushButton(self.wszystkie)
        self.wszystkieAktywuj.setObjectName(u"wszystkieAktywuj")
        self.wszystkieAktywuj.setGeometry(QRect(20, 500, 75, 23))
        self.zakladki.addTab(self.wszystkie, "")
        self.kreator = QWidget()
        self.kreator.setObjectName(u"kreator")
        self.creatorEditorGroup = QGroupBox(self.kreator)
        ...
        self.AC_Time = QGroupBox(self.AC_Group)
        ...
        self.groupBox = QGroupBox(self.AC_Group)
        ...
        self.zakladki.addTab(self.AC_Group, "")
        self.settings = QWidget()
        self.settings.setObjectName(u"settings")
        self.settingsAutosave = QCheckBox(self.settings)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Rzeczy w miejscach 0.3", None))
        self.zakladki.setTabText(self.zakladki.indexOf(self.aktywne), QCoreApplication.translate("MainWindow", u"Aktywne", None))
        ___qtablewidgetitem = self.wszystkieTablica.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"Rzeczy", None));
        ___qtablewidgetitem1 = self.wszystkieTablica.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"Miejsca", None));
        ___qtablewidgetitem2 = self.wszystkieTablica.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Czasy", None));
        ___qtablewidgetitem3 = self.wszystkieTablica.verticalHeaderItem(0)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Nowy wiersz", None));
        ___qtablewidgetitem4 = self.wszystkieTablica.verticalHeaderItem(1)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"id=0", None));
        ___qtablewidgetitem5 = self.wszystkieTablica.verticalHeaderItem(2)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", u"id=2", None));

        __sortingEnabled = self.wszystkieTablica.isSortingEnabled()
        self.wszystkieTablica.setSortingEnabled(False)
        ___qtablewidgetitem6 = self.wszystkieTablica.item(1, 0)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("MainWindow", u"Chuj", None));
        ___qtablewidgetitem7 = self.wszystkieTablica.item(1, 1)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("MainWindow", u"Tutaj", None));
        ___qtablewidgetitem8 = self.wszystkieTablica.item(2, 0)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("MainWindow", u"Z\u0142oto", None));
        ___qtablewidgetitem9 = self.wszystkieTablica.item(2, 1)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("MainWindow", u"Tam", None));
        self.wszystkieTablica.setSortingEnabled(__sortingEnabled)

        self.wszystkieUsun.setText(QCoreApplication.translate("MainWindow", u"Usu\u0144", None))
        self.wszystkieEdytuj.setText(QCoreApplication.translate("MainWindow", u"Edytuj", None))
        self.wszystkieDodaj.setText(QCoreApplication.translate("MainWindow", u"Dodaj", None))
        self.wszystkieAktywuj.setText(QCoreApplication.translate("MainWindow", u"Aktywuj", None))
        self.zakladki.setTabText(self.zakladki.indexOf(self.wszystkie), QCoreApplication.translate("MainWindow", u"Wszystkie", None))
        ...
        __sortingEnabled1 = self.creatorEditorActions.isSortingEnabled()
        ...
        self.creatorEditorActions.setSortingEnabled(__sortingEnabled1)
        ...
        self.zakladki.setTabText(self.zakladki.indexOf(self.AC_Group), QCoreApplication.translate("MainWindow", u"Autoclicker", None))
        ...
        self.zakladki.setTabText(self.zakladki.indexOf(self.settings), QCoreApplication.translate("MainWindow", u"Ustawienia", None))
    # retranslateUi
